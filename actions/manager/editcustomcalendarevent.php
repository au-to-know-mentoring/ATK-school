...
function editcustomcalendarevent_GET(Web $w)
{
    ...
    foreach (SchoolService::getInstance($w)->GetAllCustomCalendars() as $calendar) {
        //
        array_push($custom_calendar_names, [$calendar->calendar_name, $calendar->id]);
