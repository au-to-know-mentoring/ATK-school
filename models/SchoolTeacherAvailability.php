...
class SchoolTeacherAvailability extends DbObject {
    ...
    public function getStartTime() {
        ...
        if (!empty($this->dt_start_time)) {
            return formatDate($this->dt_start_time, 'H:i');
        }
        return null;
    }
    ...
    public function getEndTime() {
        ...
        if (!empty($this->dt_end_time)) {
            return formatDate($this->dt_end_time, 'H:i');
        }
        return null;
    }
    ...
    public function getDay() {
        //return formatDate($this->dt_class_date, 'H:i');
        if (!empty($this->dt_start_time)) {
            return formatDate($this->dt_start_time, 'l');
        }
        return null;
    }
    ...
    public function getStartForCurrentWeek($dateArray) {
        ...
        $weekdayNumber = formatDate($this->dt_start_time, 'w', $_SESSION['usertimezone']);
        $daysDifference = formatDate($this->dt_start_time->modify("-" . $dateArray['start'] . "weeks"), 'w', $_SESSION['usertimezone']);
        ...
        $availDate = formatDate($dateArray['start']->modify("+" . $daysDifference->days . "days"), $_SESSION['usertimezone']);
        return $availDate . " " . formatDate($this->dt_start_time, 'H:i', $_SESSION['usertimezone']);
    ...
    public function getEndForCurrentWeek($dateArray) {
        ...
        $availDate = formatDate($dateArray['start']->modify("+" . $daysDifference . "days"), $_SESSION['usertimezone']);
        return $availDate . " " . formatDate($this->dt_end_time, 'H:i', $_SESSION['usertimezone']);
